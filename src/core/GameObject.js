...
GameObject.prototype.interpolate = function(alpha) {
	...
	if (this.position_.x != this.previousPosition_.x) this.drawPosition_.x = Math.floor(this.position_.x * alpha + this.previousPosition_.x * (1 - alpha));
	if (this.position_.y != this.previousPosition_.y) this.drawPosition_.y = Math.floor(this.position_.y * alpha + this.previousPosition_.y * (1 - alpha));
}
